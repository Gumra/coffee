...
<head>
    ...
    <title>Десерты</title>
    <link rel="stylesheet" href="Category_Dessert_Style.css">
</head>
<body>
<a id="top"></a>
<div class="Upper">
            ...
            <ul class="parent">
                <li>
                    ...
                    <ul>
                        ...
                        <li> <a href="#Category_dessert">Десерты</a> </li>
        ...
        <div class="bread">
            <ul>
                <li>
                    ...
                    <a href="../Menu/Menu.php">Меню</a>
                    <a href="#" style="background-color: red">Десерты</a>
                </li>
            </ul>
        </div>
                                                <!--Конец шапки-->
                                                <!--Начало контента-->
        <div class="content">
            <a id="Category_dessert"><h1 style="color: chocolate">Десерты</h1></a>
            <div class="dessert">
                <form action="" method="get">
                    <p>Десерты/Desserts</p>
                    <table>
                        <tr>
                            <th>Название</th>
                            <th>Цена</th>
                        ...
                        <?php
                        $desserts=R::findAll('dessert');
                        if (strcmp($status,'Администратор')==0) {
                            foreach ($desserts as $dessert) {
                                echo '<tr>';
                                echo '<td><a href="../Item_Category/Item.php?id='.$dessert->id.'&&cat=dessert"/>' . $dessert->name . '</td>';
                                echo '<td>' . $dessert->price . '</td>';
                                echo '<td> <a href="../Pers_akk_redactions_admin/Pers_akk_redactions_admin.php?id=' . $dessert->id . '&&cat=dessert">Редактировать</a></td>';
                                echo '</tr>';
                            }
                        }
                        else
