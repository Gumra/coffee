...
<head>
    ...
    <link rel="stylesheet" href="Pers_akk_users_admin_style.css">
</head>
<body>
<a id="top"></a>
<div class="Upper">
        ...
        <div class="content">
            <div class="left">
                <ul class="pers_menu">
                    ...
                    <li> <a href="#" style="background-color: red">Аккаунты</a> </li>
            ...
            <div class="right">
                <form action="delete_user.php" method="get">
                    <table cellspacing="10px" style="color: var(--color-font)" width="60%">
                        ...
                        <?php
                            $users=R::findAll('profiles');
                            foreach ($users as $user)
                            {
                                echo '<tr>';
                                echo '<td>'.$user->name.'</td>';
                                echo '<td>'.$user->login.'</td>';
                                echo '<td align="center"><button style="width: 100px; height: 30px; padding: 0" name="'.$user->id.'">'."Удалить".'</button></td>';
                            }
                        ?>
                    </table>
                </form>
